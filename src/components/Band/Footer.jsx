  ...
  return (
    <>
      ...
      <div className='flex flex-col space-y-[8px]'>
              <p className='font-akira text-[20px] font-extrabold leading-[28px]'>SPECPROFILE</p>
              <p className='font-graphik text-[16px] font-normal leading-[24px]'>Copyright  2023. SpecProfile.</p>
              <p className='font-graphik text-[16px] font-normal leading-[24px]'>This site is protected by the Google Privacy Policy
